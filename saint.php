                    ...
                    <div class="package-item">
                        ...
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2"><i
                                    class="fa fa-map-marker-alt text-primary me-2"></i>Saint Catherine</small>
                            <small class="flex-fill text-center border-end py-2"><i
                                    class="fa fa-calendar-alt text-primary me-2"></i>3 days</small>
                            <small class="flex-fill text-center border-end py-2"><i
                                    class="fas fa-campground text-primary me-2"></i>Gebal</small>
                        ...
                        <div class="text-center p-4">
                            ...
                            <p>You will enjoy your holiday in Saint Catherine in a natural way;<br>This package
                                contain:<br>-Trip for 3 Pools.<br>-Hiking to Gabal Mousa.<br>-Transportation.</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        ...
                        <div class="text-center p-4">
                            ...
                            <p>You will enjoy your holiday in Saint Catherine in a natural way;<br>This package
                                contain:<br>-Trip for 3 Pools & Safari.<br>-Hiking to Gabal Mousa.<br>-Transportation.
                            </p>
                            <div class="d-flex justify-content-center mb-2">
                                <a href="booking.php#booking-form" class="btn btn-sm btn-primary px-3"
                                    style="border-radius: 30px 30px 30px 30px;">Book Now</a>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        ...
                        <div class="text-center p-4">
                            ...
                            <p>You will enjoy your holiday in Saint Catherine in a natural way;This package
                                contain:<br>-Trip for 3 Pools & Safari.<br>-Hiking to Gabal Mousa.<br>-A night at Gabl
                                Al Tawelaat.<br>-Transportation.</p>
                            <div class="d-flex justify-content-center mb-2">
                                <a href="booking.php#booking-form" class="btn btn-sm btn-primary px-3"
                                    style="border-radius: 30px 30px 30px 30px;">Book Now</a>
                            </div>
