                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item rounded pt-3">
                        <div class="p-4">
                            ...
                            <p>You can choose from more than one program and make a compare between them without wasting time.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item rounded pt-3">
                        <div class="p-4">
                            ...
                            <h5>Customize</h5>
                            <p>You can customize your own program by your self and chhose what you want what ever it will be.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item rounded pt-3">
                        <div class="p-4">
                            ...
                            <h5>Photographer</h5>
                            <p>If you need a Photographer we can provide it, and it will be with low prices and high quality.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item rounded pt-3">
                        <div class="p-4">
                            ...
                            <h5>Offers</h5>
                            <p>If you have a large number of Adventures, we can provide you a special offer for you and your group.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel position-relative">
                <div class="testimonial-item bg-white text-center border p-4">
                    <img class="bg-white rounded-circle shadow p-1 mx-auto mb-3" src="img/Valeria Pedro.jpg" style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Valeria Pedro</h5>
                    <p>Spain, Mayroka</p>
                    <p class="mt-2 mb-0">It was a good choice for me to travel with -Adventurous-, i felt the beauty of everything with them; Everthing was so easy and i am happy to knew This staff.<br> Thanks for your efforts, Everthing was great❤️💚❤️.</p>
                </div>
                <div class="testimonial-item bg-white text-center border p-4">
                    <img class="bg-white rounded-circle shadow p-1 mx-auto mb-3" src="img/Evan Igro.jpg" style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Evan Igor</h5>
                    <p>Russia, Maskova</p>
                    <p class="mt-2 mb-0">It was a good trip, Everything was so organized & Beautiful as I asked for it.<br> I hope i could join them again soon because it was so effective to me & i learned new things Thank you for everything.<br> Спасибо😍.</p>
                </div>
                <div class="testimonial-item bg-white text-center border p-4">
                    <img class="bg-white rounded-circle shadow p-1 mx-auto mb-3" src="img/Morad Khaled.jpg" style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Morad Khaled</h5>
                    <p>Egypt, Cairo</p>
                    <p class="mt-2 mb-0">It was a great exprience to join a trip with this team and i hope i could join them again soon.<br> I have seen and enjoyed many places that i didn't know before,<br>Thank you for all thge knowledge i gain from your team🥰.</p>
                </div>
                <div class="testimonial-item bg-white text-center border p-4">
                    <img class="bg-white rounded-circle shadow p-1 mx-auto mb-3" src="img/Bensu Ercel.jpg" style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Bencu Erçel</h5>
                    <p>Turkey, Ankara</p>
                    <p class="mt-2 mb-0">I can't describe how much i felt happy in this trip, Everthing was so nice the team, organization everthing really.<br> I was so depressed but after this trip i am with positive energy, It was a great experience for me💙.</p>
                </div>
                <div class="testimonial-item bg-white text-center border p-4">
                    <img class="bg-white rounded-circle shadow p-1 mx-auto mb-3" src="img/Akram Ammar.jpg" style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Akram Ammar</h5>
                    <p>UAE, Ajman</p>
                    <p class="mt-2 mb-0">I saw many natural places in this trip and i felt so happy with this team.<br> All i can say thanks for this website that make everything easy for enjoying my holiday.<br>I will join them again soon.<br> God Bless This team Inshallah😻.</p>
                </div>
                <div class="testimonial-item bg-white text-center border p-4">
                    <img class="bg-white rounded-circle shadow p-1 mx-auto mb-3" src="img/Cyrena Hani.webp" style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Cyrena Hani</h5>
                    <p>Lebanon, Beirut</p>
                    <p class="mt-2 mb-0">I booked a full board trip with Adventurous and the least i can say is that they were perfect! Starting from the website that made everything easier for me, to the very friendly staff they have, moving on to the comfortable transportation & thier drivers♥️.</p>
                </div>
                <div class="testimonial-item bg-white text-center border p-4">
                    <img class="bg-white rounded-circle shadow p-1 mx-auto mb-3" src="img/Rahul Manish1.jpg" style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Rahul Manish</h5>
                    <p>India, Chennai</p>
                    <p class="mt-2 mb-0">The trip was literally everything i dreamt of and the best thing about it is that i could plan everything i need in advance through their website.<br>Definitely it cannot be the last time using this website!!❤️</p>
                </div>
                <div class="testimonial-item bg-white text-center border p-4">
                    <img class="bg-white rounded-circle shadow p-1 mx-auto mb-3" src="img/Ava Milo.jpg" style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Ava Milo</h5>
                    <p>Kenya, Nairobi</p>
                    <p class="mt-2 mb-0">It was the most wonderful experience ever, as i was able to choose my own program through adventurous, as it is one of the easiest sites to choose distinct camping sites due to its many choices and facilitates the reservation process🤩.</p>
                </div>
                <div class="testimonial-item bg-white text-center border p-4">
                    <img class="bg-white rounded-circle shadow p-1 mx-auto mb-3" src="img/Aiden Hackson.jpeg" style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Aiden Jackson</h5>
                    <p>Canada, Toronto</p>
                    <p class="mt-2 mb-0">Everthing was great starting with choosing the camping site and the special program that I want, to the end of facilitating transportation and travel conditions .. A site that is really worth trying It has become my favorite site and I will always use it!👍🏻.</p>
                </div>
                <div class="testimonial-item bg-white text-center border p-4">
                    <img class="bg-white rounded-circle shadow p-1 mx-auto mb-3" src="img/Emilia Hans.jpg" style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Emilia Hans</h5>
                    <p>German, Dresden</p>
                    <p class="mt-2 mb-0">One of the easiest sites to book for camping, and it is characterized by many distinguished programs for the trip.<br> I was able to choose the appropriate program, which included everything I needed from the beginning of the trip to its end💜.</p>
                </div>
                <div class="testimonial-item bg-white text-center border p-4">
                    <img class="bg-white rounded-circle shadow p-1 mx-auto mb-3" src="img/Jacob Ellias.jpg" style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Jakob Elias</h5>
                    <p>Austria, Vienna</p>
                    <p class="mt-2 mb-0">Everything i asked for all the details, with the highest service from all parties to the camp crew, good treatment, cleanliness of the camp, means of transportation, drinks & food everthing was Perfect!; It can't be the last time I use this site. I will use it every time❣️.</p>
                </div>
            </div>
        </div>
    </div>
