                    ...
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item text-white active" aria-current="page">Nuweiba</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Nuweiba</h6>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="Nuweiba/Al-Magarra-Camp-Hotel-Nuweiba-Exterior.jpg" alt="">
                        </div>
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-primary me-2"></i>Nuweiba</small>
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i>5 days</small>
                            <small class="flex-fill text-center border-end py-2"><i class="fas fa-campground text-primary me-2"></i>Magarra</small>
                            <small class="flex-fill text-center py-2"><i class="fa fa-user text-primary me-2"></i>2 Person</small>
                        </div>
                        <div class="text-center p-4">
                            <h3 class="mb-0">2,650 L.E</h3>
                            <div class="mb-3">
                            ...
                            <p>You will enjoy your holiday in Magarra Camp in a simple way; This package contain:<br>-Room with 2 beds & bathroom.<br>-Trip for Wadi el Washwashi.<br>-Visit the Coloured Canyon.<br>-Snorkeling.<br>-Transportation.</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="Nuweiba/ananda-camp.jpg" alt="">
                        </div>
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-primary me-2"></i>Nuweiba</small>
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i>5 days</small>
                        ...
                        <div class="text-center p-4">
                            ...
                            <p>You will enjoy your holiday in Magarra Camp in a simple way; This package contain:<br>-Room with 1 beds & bathroom.<br>-Visit Abu Hamada Canyon.<br>-Visit Nawamis Area.<br>-Safari.<br>-Transportation.</p>
                            <div class="d-flex justify-content-center mb-2">
                                <a href="booking.php#booking-form" class="btn btn-sm btn-primary px-3" style="border-radius: 30px 30px 30px 30px;">Book Now</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="Nuweiba/348953922.jpg" alt="">
                        </div>
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-primary me-2"></i>Nuweiba</small>
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i>5 days</small>
                        ...
                        <div class="text-center p-4">
                            ...
                            <p>You will enjoy your holiday in Magarra Camp in a simple way; This package contain:<br>-Room with 2 beds & bathroom.<br>-Snorkeling.<br>-Visit the Nuweiba Castle.<br>-Visit Al Tarabin Castle.<br>-Transportation.</p>
                            <div class="d-flex justify-content-center mb-2">
                                <a href="booking.php#booking-form" class="btn btn-sm btn-primary px-3" style="border-radius: 30px 30px 30px 30px;">Book Now</a>
                            </div>
                        </div>
