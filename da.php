            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="Dahab/130800415-2938072743104296-5860533619600923305-n.jpg"
                                alt="">
                        </div>
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2"><i
                                    class="fa fa-map-marker-alt text-primary me-2"></i>Dahab</small>
                            <small class="flex-fill text-center border-end py-2"><i
                                    class="fa fa-calendar-alt text-primary me-2"></i>5 days</small>
                            <small class="flex-fill text-center border-end py-2"><i
                                    class="fas fa-campground text-primary me-2"></i>Zouqaq</small>
                        ...
                        <div class="text-center p-4">
                            ...
                            <p>You will enjoy your holiday in Zouqaq Camp in a simple way; This package
                                contain:<br>-Room with 2 beds & bathroom.<br>-Trip for Lagonna.<br>-Visit the 3
                                pools.<br>-Safari.<br>-Transportation.</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        ...
                        <div class="text-center p-4">
                            ...
                            <p>You will enjoy your holiday in Zouqaq Camp in a simple way; This package
                                contain:<br>-Room with 1 beds & bathroom.<br>-Visit the Blue Lagon.<br>-Visit the Blue
                                Hole.<br>-Visit AbuGaloum.<br>-Transportation.</p>
                            <div class="d-flex justify-content-center mb-2">
                                <a href="booking.php#booking-form" class="btn btn-sm btn-primary px-3"
                                    style="border-radius: 30px 30px 30px 30px;">Book Now</a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid"
                                src="Dahab/Qmxvb21iZXJnIEltYWdlIChGLkEp_830x550_6544189371616394933.jpg" alt="">
                        </div>
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2"><i
                                    class="fa fa-map-marker-alt text-primary me-2"></i>Dahab</small>
                        ...
                        <div class="text-center p-4">
                            ...
                            <p>You will enjoy your holiday in Zouqaq Camp in a simple way; This package
                                contain:<br>-Room with 2 beds & bathroom.<br>-Trip for Lagonna.<br>-A Trip Full Board in
                                the sea at yachit.<br>-Safari<br>-Transportation.</p>
                            <div class="d-flex justify-content-center mb-2">
                                <a href="booking.php#booking-form" class="btn btn-sm btn-primary px-3"
                                    style="border-radius: 30px 30px 30px 30px;">Book Now</a>
                            </div>
