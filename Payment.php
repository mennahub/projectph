...
<body>
    ...
    <div class="text-center pb-4 wow fadeInUp" data-wow-delay="0.1s">
        <p class="text-dark" style="font-size: 24px;font-weight: bold;">One Last Step!</p>
        <img src="Logos/mastercard.svg" width="100" height="100">
        <img src="Logos/visa.svg" width="100" height="100">
        <img src="Logos/VF.svg" width="100" height="100">
        <div id="payment-details">
            <!-- We will use JS for rendering this -->
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        const packageName = urlSearchParams.get('packageName');
        const bookingDate = urlSearchParams.get('bookingDate');
        const packageDetails = packagesMap.get(packageName);
        const customerName = urlSearchParams.get('customerName');

        $('#payment-details').append(`
            <h2 class="pay">Payment Details!</h2>
            <h3 class="pay">Customer Name: ${customerName}</h3>
            <h3 class="pay">Package Name: ${packageName}</h3>
            <h3 class="pay">Booking Date: ${bookingDate}</h3>
            <h3 class="pay">Description: ${packageDetails.description}</h3>
            <h3 class="paye">Package Price: ${packageDetails.price} L.E</h3>
